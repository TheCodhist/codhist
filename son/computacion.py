...
def main():
    ...
    # Agrupar las edades por año
    for i in range(len(edades)):
        año = año_creacion_cuentas[i]
        edad_cuenta = edades[i]
        
        # Si el año no está en el diccionario, crear una lista vacía
        if año not in edades_por_año:
            edades_por_año[año] = []  # Crear una lista vacía para ese año
        
        # Añadir la edad a la lista correspondiente al año
        edades_por_año[año].append(edad_cuenta)

    # Calcular la media de edades por año
    media_edad_por_año = {}

    for año in edades_por_año:
        edades_año = edades_por_año[año]
        media = sum(edades_año) / len(edades_año)  # Calcular la media
        media_edad_por_año[año] = media  # Almacenar la media en el diccionario

    # Extraer los datos para graficar
    años = list(sorted(media_edad_por_año.keys()))  # Los años en el eje X
    medias = list(media_edad_por_año.values())  # Las medias de edad en el eje Y

    # Graficar los datos
    plt.plot(años, medias, marker='o', linestyle='-', color='b', label='Media de edad')

    # Agregar etiquetas y título
    plt.xlabel('Año de Creación de Cuenta')
    plt.ylabel('Media de Edad')
    plt.title('Evolución de la Edad Promedio por Año')
    plt.grid(True)
